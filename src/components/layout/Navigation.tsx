...
export function Navigation() {
  ...
  const mobileLinkClass = (args: { isActive: boolean }) =>
    [linkClass(args), 'block w-full py-2.5'].join(' ')
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-bg-base/80 backdrop-blur-md border-b border-border-subtle">
      <div className="max-w-7xl mx-auto px-6 h-11 flex items-center justify-between">
        ...
        <button
          ...
          className="sm:hidden p-1.5 text-text-muted hover:text-purple-light transition-colors duration-150 cursor-pointer"
        >
